...
public class LinoxImageStore extends JTabbedPane {
    ...
    private class TabCloseUI implements MouseListener, MouseMotionListener {
        ...
        public void mouseClicked(MouseEvent e) {
            try {
                DataCollection.INSTANCE.setImageOriginal(((ImageJPanel) tabbedPane.getSelectedComponent()).getImage());
                Linox.getInstance().getStatusBar().setStatus(DataCollection.INSTANCE.getImageOriginal().getTitle() + ": width = " + DataCollection.INSTANCE.getImageOriginal().getWidth() + " height = " + DataCollection.INSTANCE.getImageOriginal().getHeight());
