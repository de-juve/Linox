...
public class LineExtrapolation{

    public Integer lagrange(double x, LinkedList<LinePoint> line) {
        Integer L;
        double l;
        L = 0;
    ...
    public void buildSpline(LinkedList<LinePoint> line, SplineTuple[] splines) {
        int n = line.size();
